...
export function ThemeProvider({ children, ...props }: ThemeProviderProps) {
  const [aiSelectedModels, setAiSelectedModels] = React.useState<AIModelsType>(DefaultModel);
  const { user, isLoaded } = useUser();
  const [userDetail, setUserDetail] = React.useState<DocumentData | null>(null);
